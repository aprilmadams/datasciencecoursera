  ##
	  ...
	  setwd("C:/Users/April/Desktop/April Job Search/R programming/data")

	 install.packages("plyr")

	Installing package into ‘C:/Users/April/Documents/R/win-library/3.3’

	(as ‘lib’ is unspecified)

	--- Please select a CRAN mirror for use in this session ---

	trying URL 'https://cran.revolutionanalytics.com/bin/windows/contrib/3.3/plyr_1.8.4.zip'

	Content type 'application/zip' length 1189045 bytes (1.1 MB)
	...
	The downloaded binary packages are in
	        ...
	        C:\Users\April\AppData\Local\Temp\RtmpkvnCOn\downloaded_packages
	...
	In file(file, "rt") :
	  ...
	  cannot open file './train/subject_train.txt': No such file or directory
